...
extern UINT X11DRV_GetDeviceGammaRamp( PHYSDEV dev, LPVOID ramp );
...
extern Window x11drv_client_surface_create( HWND hwnd, BOOL raw, int format, struct client_surface **client );
